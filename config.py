...
main_directory = '/g/data/y89/xw5841/galah_rv_const'

# the intermediate directory to dump files needed to run the code 
info_directory = '/g/data/y89/xw5841/galah_rv_const/data'
...
DR = 'galah_dr4_allstar_230731.fits'

# results directory
output_directory = '/g/data/y89/xw5841/galah_rv_const/results'
